...
import com.example.qrscanner.utils.CameraUtils;
import com.example.qrscanner.utils.CameraWrapperUtils;
import com.example.qrscanner.utils.IViewFinder;
import com.example.qrscanner.utils.PreviewUtils;
import com.example.qrscanner.utils.ThreadUtils;


public abstract class BarcodeScannerView extends FrameLayout implements Camera.PreviewCallback  {

    private CameraWrapperUtils mCameraWrapper;
    private PreviewUtils mPreview;
    private IViewFinder mViewFinderView;
    private Rect mFramingRectInPreview;
    private ThreadUtils mCameraHandlerThread;
    ...
    public final void setupLayout(CameraWrapperUtils cameraWrapper) {
        removeAllViews();

        mPreview = new PreviewUtils(getContext(), cameraWrapper, this);
    ...
    public void startCamera(int cameraId) {
        if(mCameraHandlerThread == null) {
            mCameraHandlerThread = new ThreadUtils(this);
        }
        mCameraHandlerThread.startCamera(cameraId);
    }

    public void setupCameraPreview(CameraWrapperUtils cameraWrapper) {
