...
import com.example.qrscanner.utils.DisplayUtils;
...
public class VikasQrScannerView extends BarcodeScannerView {
    ...
    public VikasQrScannerView(Context context) {
        super(context);
        initMultiFormatReader();
    }

    public VikasQrScannerView(Context context, AttributeSet attributeSet) {
