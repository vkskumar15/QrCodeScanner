...
public class PreviewUtils extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public PreviewUtils(Context context, CameraWrapperUtils cameraWrapper, Camera.PreviewCallback previewCallback) {
        super(context);
        init(cameraWrapper, previewCallback);
    }

    public PreviewUtils(Context context, AttributeSet attrs, CameraWrapperUtils cameraWrapper, Camera.PreviewCallback previewCallback) {
        super(context, attrs);
        init(cameraWrapper, previewCallback);
    }

    public void init(CameraWrapperUtils cameraWrapper, Camera.PreviewCallback previewCallback) {
    ...
    public void setCamera(CameraWrapperUtils cameraWrapper, Camera.PreviewCallback previewCallback) {
